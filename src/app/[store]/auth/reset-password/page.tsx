...
export default function CustomerResetPasswordPage({ params }: { params: { store: string } }) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (error) {
            ...
            setTimeout(() => router.push(`/${params.store}/auth`), 2000)
        }
    }
                ...
                <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8 space-y-6">
                    ...
                    {status === 'success' ? (
                        <div className="bg-green-50 border border-green-200 rounded-xl p-5 flex flex-col items-center text-center gap-3">
                            ...
                            <div>
                                <p className="font-bold text-green-800">Password updated successfully!</p>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div>
                                ...
                                <PasswordInput
                                    ...
                                    autoComplete="new-password"
                                    required
                                    className={`w-full border rounded-xl px-4 py-3 min-h-[48px] focus:ring-2 focus:border-transparent outline-none text-gray-900 transition ${mismatch ? 'border-red-300 focus:ring-red-400' : 'focus:ring-primary'
                                        }`}
                                />
                                {mismatch && (
                            ...
                            <button
                                ...
                                className="w-full bg-primary text-white font-bold py-3 min-h-[48px] rounded-xl hover:opacity-90 transition flex items-center justify-center gap-2 disabled:opacity-60"
                            >
                            ...
                            {!sessionReady && (
                                <p className="text-center text-xs text-gray-400">
                                    ...
                                    <Link href={`/${params.store}/auth/forgot-password`} className="text-primary underline">
                                        Request new link
                                    </Link>
                                </p>
                            )}
